...
S.append((5, 'What clients are buying', 'Volumes disclosed by the firms themselves over the last twelve months: account counts, tonnes and balances.', [
 ...
 (7, 'Korea: the three banks\' gold-banking balances peaked at KRW 2.44 trn in January 2026 and stood at KRW 1.79 trn on 14 August 2026. The series measures customer account balances, which are liabilities of the banks and move with the gold price, not metal the banks hold. Four banks sold 3,745 kg of bars in 2025.', 'https://www.fnnews.com/news/202606161819598224'),
...
fam = [
 (16, 'Gold account, unallocated', 'gold_account_unallocated',
  'A claim on the bank for a number of grams or ounces, with no specific bars set aside. Priced off the LBMA benchmark or the bank\'s own two-way price, and hedged in the interbank market. The cheapest kind to run, and usually carries no right to take delivery.',
  'Swiss metal-account fees run from 0.20% a year at Luzerner Kantonalbank, through 0.30% at Basler Kantonalbank for gold, to 0.80% on the former Credit Suisse book now inside UBS. UOB\'s Gold Savings Account moved to a flat 0.25% a year on 1 April 2026, with a 5 g minimum and conversion to physical in 100 g increments. Emirates NBD gram gold charges an arrangement fee of up to 2.1%, an acquisition fee of AED 0.1575 a gram, and custody and insurance at 0.315% a year accrued monthly and collected at redemption, stepping up to 1.05% a year after five years, with a 0.525% redemption charge. HSBC Wayfoong Statement Gold caps the spread at 4%. Citi Hong Kong Gold Manager charges the spread only.'),
 (17, 'Metal account, allocated', 'gold_account_allocated',
  'The client owns identified bars, or a pro-rata share of a pool, held in a named vault. The bank earns a custody fee and the dealing spread.',
  'UBS key4 gold charges 0.35% a year for storage, from 0.1 g. Intesa Deposito Oro charges 0.75% a year. Royal Canadian Mint exchange-traded receipts charge 0.35% for gold and 0.45% for silver, and BMO\'s Gold Deposit Program custodies at the same Mint. JPMorgan Private Bank holds client gold in its own vault, with unallocated claims from around USD 250,000 and allocated 400 oz bars from around USD 1m, plus storage and insurance.'),
 (18, 'Physical bars and coins', 'physical_bullion',
  'Sold over the counter, in the app, or delivered, then either stored by the bank or taken away. The volume driver in Asia and Germany. The buy-back policy is effectively the product: OCBC Hong Kong withdrew bar buy-back on 1 February 2026.',
  'Sold by Reisebank, ZKB, UOB, Shinhan, Emirates NBD under its own brand, and the Canadian bank online stores. Fidelity, through FideliTrade, charges 2.90% down to 0.99% to buy and 2.00% down to 0.75% to sell, with storage at 0.125% a quarter.'),
 (19, 'Savings and accumulation plans', 'gold_savings_plan',
  'Monthly accumulation in grams or whole coins from a small ticket. The entry product for mass-affluent clients, and the feeder into the account business.',
  'Reisebank\'s Goldsparplan starts at EUR 25 a month and Austrian Sparkassen coin plans at EUR 50. Garanti funds its plan from the client\'s credit-card limit. Bank Syariah Indonesia takes subscriptions from 0.02 g. Volumes on Bank of Taiwan\'s regular plan grew 40% in 2025.'),
 (20, 'Digital gold and tokens', 'digital_gold_token',
  'A tokenised claim on vaulted gold, dealt around the clock in fractional units. The retail growth product of 2025 and 2026 in Hong Kong and Singapore.',
  'HSBC Gold Token trades in 0.001 oz units with no dealing or storage fee, but a bank margin of up to 2%, or 5% outside local trading hours, and no right to delivery; more than USD 1bn had traded by November 2025, with the bullion vaulted in London. DBS announced a 1 g token held in its own Singapore vault in June 2026. AMINA lends against its gold token.'),
 (21, 'Gold deposits and dual-currency investments', 'gold_deposit_dci',
  'A term product with two common shapes. Either the client\'s gold earns a yield because the bank lends it on, or a cash deposit converts into gold at maturity if the price passes an agreed level. Uncommon outside Turkey, China and Malaysia, and the kind of product a bullion desk prices directly.',
  'China Merchants Bank\'s 金生利 credits a return in grams of gold; press reporting puts its gold-account rates between 0.01% on demand and about 0.3% for one year, and the bank\'s own pages could not be read directly. Kuveyt Türk runs a gold participation account that shares profit with the client on a 40/60 basis and pays it in gold, over one to twelve months. CIMB\'s Gold Convertible treats gold as the second currency. HSBC China sells gold-linked structured deposits, and Citi Hong Kong offers Gold Premium Investment.'),
 (22, 'Structured notes on gold', 'structured_note',
  'Autocallables, reverse convertibles and capital-protected notes referencing the gold price. Distributed through the private-bank advisory channel and hedged by the issuing desk.',
  'Vontobel carried CHF 1.33bn of physical metal at the end of 2025 to hedge its metal-linked products. Citi issues market-linked notes on the SPDR Gold Trust for the Wells Fargo Advisors shelf.'),
 (23, 'Lending against metal', 'lombard_vs_metal',
  'Borrowing secured on bullion, on a metal account, or on metal exchange-traded funds. Rare among UK and US banks.',
  'Swiss houses lend against metal accounts and bullion but do not publish advance rates by asset type. Published advance rates against metal are rare: Saxo Bank publishes collateral value by instrument rating, 75% at the highest rating, while specialist US bullion lenders quote figures inconsistently across their own material and are best treated as indicative. AMINA extends credit lines against its own gold token. ANZ Investment Lending accepts the ASX-listed gold products as collateral.'),
 (24, 'Own funds, ETFs and the house allocation', 'own_fund_etf',
  'The house implements its published view on gold through a vehicle it controls, which is how discretionary mandates get the exposure.',
  'ANZ Private seeded a State Street gold fund charging 0.14% in July 2024 and maintains an overweight. JPMorgan Private Bank recommends around 5%. HSBC Global Private Banking is overweight gold. Coutts and ABN AMRO have both added gold sleeves to their model portfolios.'),
]
...
S.append((5, 'Five competitor product designs', 'Each of these is live today.', [
 (69, 'JPMorgan Private Bank: gold claims held in its own vault, with unallocated claims from around USD 250,000 and allocated 400 oz bars from around USD 1m plus storage and insurance, alongside a house allocation to gold of around 5%. The desk-and-vault product; Citi now has the London vault to match it.', 'https://www.cnbc.com/'),
...
S.append((4, 'Citi today, as the client sees it', 'What is publicly advertised to clients, market by market, kept separate from private-bank capability and from the institutional franchise. Checked 11 September 2026.', [
 ...
 (0, 'The institutional franchise is the part that is already large. Citibank N.A. is one of only six LBMA full market makers quoting spot, forwards and options in gold and silver; Citi is one of eight custodians listed by the LBMA as offering vaulting in London; it became the fifth LPMCL clearing member on 6 July 2026; and it carried USD 235.6bn of precious-metals derivative notional at 31 March 2026 against JPMorgan\'s USD 509.4bn, the second-largest book of any US bank. Notional is not exposure, and the series has included gold since a 2022 reclassification, so it is not comparable with pre-2022 figures.', 'https://www.occ.gov/publications-and-resources/publications/quarterly-report-on-bank-trading-and-derivatives-activities/'),
