...
fam = [
 (16, 'Gold account, unallocated', 'gold_account_unallocated',
  ...
  'Swiss metal-account fees run from 0.20% a year at Luzerner Kantonalbank, through 0.30% at Basler Kantonalbank for gold, to 0.80% on the former Credit Suisse book now inside UBS. UOB Gold Savings charges 0.25% a year. Emirates NBD gram gold charges a 2.1% arrangement fee below USD 250,000, plus a one-off 0.315% custody and insurance charge if the client redeems within five years, or 1.05% after that. HSBC Wayfoong Statement Gold caps the spread at 4%. Citi Hong Kong Gold Manager charges the spread only.'),
 ...
 (21, 'Gold deposits and dual-currency investments', 'gold_deposit_dci',
  ...
  'China Merchants Bank\'s 金生利 pays the yield in grams of gold. Kuveyt Türk runs a gold-to-gold participation account. CIMB\'s Gold Convertible treats gold as the second currency. HSBC China sells gold-linked structured deposits, and Citi Hong Kong offers Gold Premium Investment.'),
 ...
 (23, 'Lending against metal', 'lombard_vs_metal',
  ...
  'Swiss houses lend against metal accounts and bullion but do not publish advance rates by asset type. Money Metals lends up to 65% against bullion in the US. AMINA extends credit lines against its own gold token. ANZ Investment Lending accepts the ASX-listed gold products as collateral.'),
