...
S = []
S.append((2, 'Why we are here', 'One sentence for the room: every competitor wealth franchise now sells gold to its clients in some form, and Citi Wealth\'s client-facing metals shelf is one paper-gold product in one booking centre.', [
...
S.append((4, 'Citi Wealth today, as the client sees it', 'What is on Citi\'s own client pages across booking centres, from the same sweep applied to every competitor.', [
 (74, 'The only advertised client gold product anywhere is the Hong Kong "Gold Manager": cash-settled, loco-London-referenced paper gold, HKD 5,000 minimum, no delivery, plus a Gold Premium Investment deposit.', 'https://www.citibank.com.hk/'),
 (75, 'Our sweep of Citi\'s US, Singapore, UAE and UK client sites found nothing comparable marketed. Structured notes, OTC hedging and securities-backed lending exist but are not presented as metals products.', ''),
 ...
 (77, 'The plumbing gap is not on the desk side: LBMA market maker, fifth LPMCL member since 6 July 2026, London vault on the LBMA custodian list run with Malca-Amit, US$236bn precious-metals derivative book at March 2026.', 'https://www.citigroup.com/global/news/press-release/2026/citi-clearing-member-london-precious-metals-clearing-limited')], None))
...
S.append((4, 'A shelf Citi Wealth could launch', 'Three tiers, each backed by a competitor product that already exists and by desk capability that already exists.', [
 (81, 'Tier 1 (private bank, all booking centres): allocated precious-metals account in the Citi London vault with physical delivery via Malca-Amit, plus Lombard lending against it. Template: JPMorgan PB vault claims; Julius Baer / LGT metal accounts.', ''),
 (82, 'Tier 2 (Citigold / Citigold Private Client in SG, HK, UAE, UK): unallocated gram-gold account with physical redemption in kilobars or 100 g, priced off loco-London, desk-hedged. Template: UOB Gold Savings, Emirates NBD gram gold, HSBC Wayfoong Statement Gold; extend Gold Manager beyond HK and add delivery.', ''),
 (83, 'Tier 3 (yield and structured): gold-linked deposits and a gold DCI where the desk\'s lease book funds the client yield; a standing gold autocall/reverse-convertible programme; a house strategic-allocation view implemented via a physically backed vehicle. Templates: CMB, Kuveyt Türk, CIMB Gold Convertible, HSBC China structured deposits, ANZ Private gold fund.', ''),
...
S.append((4, 'Risks and the questions you will get', 'Short answers ready for the room.', [
 ...
 (86, 'Conduct: unallocated accounts are a claim on the bank, not metal; say so in the T&Cs (BEA\'s Gold Account brochure and HSBC\'s Wayfoong Statement Gold key facts do). Buy-back policy is a promise that gets tested (OCBC Hong Kong withdrew bar buy-back in February 2026).', 'https://www.hkbea.com/pdf/en/pdf/account-services/Gold_Account_Principal_Brochure.pdf'),
 (87, 'Regulation: mainland China froze new paper-gold positions in 2022 and the retreat is accelerating; Shariah products need an immediate-ownership structure such as the bai\' as-sarf contract Maybank\'s MIGA-i describes.', ''),
 ...
 (89, 'Conflicts: Citi is already fund-level custodian or note issuer for competitor products (Betashares QAU per its PDS, where JPMorgan holds the bullion; Citi gold-linked notes on the Wells Fargo shelf). Map them before launch.', ''),
 (90, 'Counterparty: in our dataset, 45 of the 91 largest competitor metals books name no liquidity provider. That is the desk\'s pitch list, and it is the same names the wealth business will compete with.', '')], None))
